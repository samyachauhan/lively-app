...
struct DracaenaMarginata: View {
    @State private var plantNames = ["Drake"]
    @State private var waterIn = [30]
    ...
    @State private var moistureAmount = [83.2]
    @State private var image = "dracaenaMarginata"
...
struct DracaenaMarginata_Previews: PreviewProvider {
