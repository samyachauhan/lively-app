...
struct Marigold: View {
    @State private var plantNames = ["Mary"]
    @State private var waterIn = [5]
    @State private var rotateIn = [4]
    @State private var fertilizeIn = [15]
    @State private var amountToWater = ["3/4 Cup"]
    @State private var temperature = [68]
    @State private var moistureAmount = [36.7]
    @State private var image = "marigold"
...
struct Marigold_Previews: PreviewProvider {
