...
struct Anthurium: View {
    @State private var plantNames = ["Axel"]
    @State private var waterIn = [15]
    @State private var rotateIn = [56]
    @State private var fertilizeIn = [0]
    @State private var amountToWater = ["1 Cup"]
    @State private var temperature = [68]
    @State private var moistureAmount = [72.3]
    @State private var image = "anthurium"
...
struct Anthurium_Previews: PreviewProvider {
