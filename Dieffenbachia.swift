...
struct Dieffenbachia: View {
    @State private var plantNames = ["Lily"]
    ...
    @State private var image = "dieffenbachia"
                ...
                HStack(spacing: 0){
                    ZStack (){
                        ...
                        Text("\(moistureAmount[0], specifier: "%.1f")%")
                            ...
                            .foregroundColor(.black)
                            .bold()
                    }.frame(width: 200, height: 200).offset(x:-40)
...
struct Dieffenbachia_Previews: PreviewProvider {
